defmodule Memcache.ClientTest.Transcoder do
  ...
  test "raw transcoder encode_value" do
    ...
    {:ok, encoded, data_type} = Memcache.Client.Transcoder.encode_value("test")
    assert encoded == "test"
    assert data_type == 0x0000
  end

  test "raw transcoder decode_value" do
    assert {:ok, "test"} == Memcache.Client.Transcoder.decode_value("test", 0x0000)
  ...
  test "json transcoder encode_value" do
    ...
    {:ok, encoded, data_type} = Memcache.Client.Transcoder.encode_value(%{})
  ...
  test "json transocder decode_value" do
    ...
    assert {:ok, %{}} == Memcache.Client.Transcoder.decode_value("{}", 0x0002)
  ...
  test "json transocder decode_value with opts" do
    ...
    assert {:ok, %{test: "test"}} == Memcache.Client.Transcoder.decode_value("{\"test\": \"test\"}", 0x0002)
  ...
  test "erlang transcoder decode_value" do
    ...
    assert {:ok, %{}} == Memcache.Client.Transcoder.decode_value(<<131, 116, 0, 0, 0, 0>>, 0x0004)
